      ...
      if (slashCommand.userPerms || slashCommand.botPerms) {
        if (
          ...
          const userPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Tu n'as pas les \`${slashCommand.userPerms}\` permissions pour utiliser cette commande!`
            )
            .setColor("Red");
        ...
        if (
          ...
          const botPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Tu n'as pas les \`${slashCommand.botPerms}\` permissions pour utiliser cette commande!`
            )
            .setColor("Red");
